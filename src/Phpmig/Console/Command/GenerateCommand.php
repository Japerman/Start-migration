...
class GenerateCommand extends AbstractCommand
{
    ...
    protected function configure()
    {
        ...
        $this->setName('generate')
             ...
             ->addArgument('path', InputArgument::OPTIONAL, 'The directory in which to put the migration ( optional if start.migrations_path is setted )')
...
<info>start generate Dave ./migrations</info>
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if( null === $path ){
            if (isset($this->container['start.migrations_path'])) {
                $path = $this->container['start.migrations_path'];
            }
            if (isset($this->container['start.sets']) && isset($this->container['start.sets'][$set]['migrations_path'])) {
                $path = $this->container['start.sets'][$set]['migrations_path'];
            }
        }
        ...
        if (isset($this->container['start.migrations_template_path'])) {
            $migrationsTemplatePath = $this->container['start.migrations_template_path'];
