...
class InitCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testExecuteCreatesBootstrapFile()
    {
        ...
        $this->assertTrue(file_exists($tempDir . DIRECTORY_SEPARATOR . 'start.php'));
    }
    ...
    public function testExecuteBootstrapFileExists()
    {
        ...
        touch($tempDir . DIRECTORY_SEPARATOR . 'start.php');

        $tester->execute(array('command' => $command->getName()));

        $this->assertContains('start.php already exists', $tester->getDisplay());
    }
