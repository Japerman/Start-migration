...
EOT
    ...
    {
        $cwd = getcwd();
        $bootstrap = $cwd . DIRECTORY_SEPARATOR . 'start.php';
        $relative = 'migrations';
...
// replace this with a better Start\Adapter\AdapterInterface
\$container['start.adapter'] = new Adapter\File\Flat(__DIR__ . DIRECTORY_SEPARATOR . '$migrations/.migrations.log');

\$container['start.migrations_path'] = __DIR__ . DIRECTORY_SEPARATOR . 'migrations';

// You can also provide an array of migration files
// \$container['start.migrations'] = array_merge(
